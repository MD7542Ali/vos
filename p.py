...
OWNER_ID = 948895728  # Replace with your owner Telegram ID
...
def start(message):
    ...
    if user_id not in AUTHORIZED_USERS:
        bot.send_message(message.chat.id, "🚫 Access Denied! Contact the owner for assistance: @IPxKlNGYT")
    else:
        welcome_message = (
            ...
            "📞 Contact the owner on Instagram and Telegram: @IPxKlNGYT\n"
...
def owner(message):
    ...
    bot.send_message(message.chat.id, "📞 Contact the owner: @IPxKlNGYT")
...
This bot is owned and operated by @IPxKlNGYT on Telegram and KaliaYtOwner on Instagram. By using this bot, you acknowledge that you understand and agree to the following terms:
